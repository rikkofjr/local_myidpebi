...
class act_form extends \moodleform {
    ...
    public function validation($data, $files) {
        ...
        $jp_rules = [
            ...
            'Seminar'                   => ['min' => 0, 'max' => 4,   'label' => 'Seminar'],
            'Workshop'                  => ['min' => 0, 'max' => 5,  'label' => 'Workshop'],
            'Bimbingan Teknis'          => ['min' => 0, 'max' => 20,  'label' => 'Bimbingan Teknis'],
            'Pertukaran Karyawan'       => ['min' => 0, 'max' => 20,  'label' => 'Pertukaran Karyawan'],
            'Magang'                    => ['min' => 0, 'max' => 20,  'label' => 'Magang'],
            'Benchmarking'              => ['min' => 0, 'max' => 10,  'label' => 'Benchmarking'],
            'Pelatihan Jarak Jauh'      => ['min' => 0, 'max' => 20,  'label' => 'Pelatihan Jarak Jauh'],
            'Coaching'                  => ['min' => 0, 'max' => 2,   'label' => 'Coaching'],
            'Mentoring'                 => ['min' => 0, 'max' => 2,   'label' => 'Mentoring'],
            'Secondments'               => ['min' => 0, 'max' => 20,   'label' => 'Secondments'],
            'Melakukan sharing session' => ['min' => 0, 'max' => 2,   'label' => 'Melakukan sharing session'],
            'Komunitas Belajar'         => ['min' => 0, 'max' => 2,   'label' => 'Komunitas Belajar'],
            'Mengikuti sharing session dari asosiasi'=> ['min' => 0, 'max' => 4,   'label' => 'Mengikuti sharing session dari asosiasi'],
            'Menjadi Narasumber dalam asosiasi'=> ['min' => 0, 'max' => 5,   'label' => 'Menjadi Narasumber dalam asosiasi'],
            'Outbond'                   => ['min' => 0, 'max' => 20,   'label' => 'Outbond'],
            'Daily Practice'            => ['min' => null, 'max' => 1,   'label' => 'Daily Practice'],
            'Belajar Mandiri'           => ['min' => 0, 'max' => 2,   'label' => 'Belajar Mandiri'],
            'Mereview buku/artikel'           => ['min' => 0, 'max' => 4,   'label' => 'Mereview buku/artikel'],
            'Keterlibatan Project'           => ['min' => 0, 'max' => 10,   'label' => 'Keterlibatan Project'],
        ];
